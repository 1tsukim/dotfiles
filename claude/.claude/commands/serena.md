...
description: Manual command — invoke explicitly with `/serena <problem> [options]` to use Serena MCP with structured thinking patterns (debug / design / review / implement). Not for autonomous selection; options like -q/-d/-c/-s require explicit user invocation.
---
